...
# File paths
input_file_path = 'processed_airdrops_data_latest_ITP1_updated_with_temp.csv'
output_file_path = 'processed_airdrops_data_latest_ITP1_updated_with_temp_labelled.csv'
